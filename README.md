...
End-to-end tests are designed to test the account transactions. Before starting running tests, you need to run `docker-compose up` which runs four Substrate nodes.
